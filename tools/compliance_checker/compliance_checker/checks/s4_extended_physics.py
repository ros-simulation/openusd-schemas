...
def _check_cycle_free_graph(mimic_graph: dict[str, list[str]], stage: Usd.Stage) -> list:
    errors = []
...
def _validate_extended_physics_mimic(stage: Usd.Stage, timeRange: TimeRange) -> list:
    errors = []
...
def _validate_extended_physics_actuator(stage: Usd.Stage, timeRange: TimeRange) -> list:
    errors = []
    for prim in stage.TraverseAll():
...
def _validate_extended_physics_position_clamping(stage: Usd.Stage, timeRange: TimeRange) -> list:
    errors = []
    for prim in stage.TraverseAll():
